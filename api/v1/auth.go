...
import (
	...
	emailPkg "github.com/mirasildev/exam_project_2.0/pkg/email"
...
// @Router /auth/register-as-a-partner [post]
...
func (h *handlerV1) RegisterAsAPartner(c *gin.Context){
	var (
